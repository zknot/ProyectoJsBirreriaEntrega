class Cervezas {
    constructor(id, marca, precio, cantidad, descripcion, img){
        this.id = id
        this.marca = marca
        this.precio = precio
